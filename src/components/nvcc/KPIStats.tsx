...
export function KPIStats({ stats, realtime, loading, totalCameras = 0, isSingleCamera = false }: KPIStatsProps) {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Card className="glass p-4 flex flex-row items-center justify-between relative overflow-hidden group hover:scale-[1.02] transition-transform duration-200">
                <div className="absolute -top-6 right-0 w-24 h-24 rounded-full blur-2xl opacity-20 group-hover:opacity-30 transition-opacity bg-yellow-500" />
                ...
                <div className="w-14 h-14 rounded-2xl flex items-center justify-center relative z-10 shrink-0 bg-yellow-500/10 text-yellow-500">
                    <Activity className="w-7 h-7" />
                </div>
            </Card>
