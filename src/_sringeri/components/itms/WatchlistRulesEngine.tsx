...
import { apiClient, type Watchlist } from '@sringeri/lib/api';
...
const RuleIcon = ({ type, className }: { type: string; className?: string }) => {
  ...
  switch (type) {
    ...
    case 'location': return <MapPin {...colorProps('text-amber-400')} />;
    case 'time': return <Moon {...colorProps('text-amber-400')} />;
    ...
    default: return <Shield {...colorProps('text-amber-400')} />;
  }
};
