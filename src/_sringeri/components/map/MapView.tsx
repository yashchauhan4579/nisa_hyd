...
import { apiClient, type DeviceMapMarker, type Device, type Hotspot } from '@sringeri/lib/api';
import { Camera as CameraIcon, Activity, Plane, Radio, Users, AlertTriangle, Layers } from 'lucide-react';
import { useDeviceFilter } from '@sringeri/contexts/DeviceFilterContext';
import { useLayerVisibility } from '@sringeri/contexts/LayerVisibilityContext';
import { useMapType } from '@sringeri/contexts/MapTypeContext';
