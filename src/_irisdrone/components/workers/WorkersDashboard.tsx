...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@irisdrone/components/ui/card';
import { Empty, EmptyIcon, EmptyTitle, EmptyDescription, EmptyActions } from '@irisdrone/components/ui/empty';
import { Button } from '@irisdrone/components/ui/button';
import { HudBadge } from '@irisdrone/components/ui/hud-badge';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@irisdrone/components/ui/tabs';
...
import type { 
  ...
  WorkerStatus
} from '@irisdrone/lib/worker-types';
