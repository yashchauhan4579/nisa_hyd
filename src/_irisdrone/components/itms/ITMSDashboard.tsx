...
import { apiClient, type ViolationStats, type TrafficViolation, type VCCStats } from '@irisdrone/lib/api';
...
import { useCountUp } from '@irisdrone/hooks/useCountUp';
...
export function ITMSDashboard() {
  ...
  const getViolationTypeColor = (type: string) => {
    const colors: Record<string, string> = {
      ...
      RIDER_HELMET: 'bg-orange-500/10 text-orange-400',
      PILLION_HELMET: 'bg-orange-400/10 text-orange-300',
      ...
      UNCOVERED_LOAD: 'bg-orange-500/10 text-orange-400',
      ILLEGAL_PARKING: 'bg-zinc-500/10 text-zinc-400',
      TRIPLE_RIDING: 'bg-amber-500/10 text-amber-400',
      MINOR_RIDER: 'bg-amber-500/10 text-amber-400',
      MOBILE_USE: 'bg-rose-500/10 text-rose-400',
            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-3">
              ...
              <div className="col-span-1 sm:col-span-6">
                {primaryViolation ? (
                  ...
                  <div className="w-full aspect-[9/16] max-h-[50vh] bg-zinc-900/30 border border-white/5 rounded-lg">
              ...
              <div className="col-span-1 sm:col-span-6">
                {primaryViolation ? (
                  ...
                  <div className="bg-zinc-900/30 border border-white/5 rounded-lg p-3 h-full">
                    <Empty className="h-full">
                      <EmptyIcon><AlertTriangle /></EmptyIcon>
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              <div className="bg-zinc-900/30 border border-white/5 rounded-lg p-3">
                ...
                {violationTypeData.length > 0 ? (
                  ...
                  <Empty className="min-h-0 py-6">
                    <EmptyIcon><AlertTriangle /></EmptyIcon>
                    <EmptyTitle>No violation data</EmptyTitle>
                  </Empty>
                )}
              </div>
            </div>
