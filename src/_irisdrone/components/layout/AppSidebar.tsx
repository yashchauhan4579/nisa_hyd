...
import {
  Camera, Map, BarChart3, Settings, Bell, Users, AlertTriangle, Car,
  TrendingUp, Server, Eye, Shield,
  LayoutDashboard, CheckSquare, FileSearch, LineChart, Filter,
  Box, ChevronDown, Hexagon, Sun, Moon, PanelLeftClose, PanelLeft, LogOut
} from 'lucide-react';
import {
  Sidebar,
  useSidebar,
} from '@irisdrone/components/ui/sidebar';
...
const modules: NavModule[] = [
  {
    ...
    items: [
      ...
      { path: '/itms/violations', label: 'Violations', icon: AlertTriangle, badge: 12 },
      { path: '/itms/watchlist', label: 'Watchlist', icon: Eye },
      { path: '/itms/alerts', label: 'Alerts', icon: Bell, badge: 3 },
      ...
      { path: '/itms/watchlist/rules', label: 'Watchlist Rules', icon: Filter },
    ],
    subGroups: [],
  },
  {
    ...
    items: [
      ...
      { path: '/crowd', label: 'Crowd Analytics', icon: Users },
    ],
  },
  {
    id: 'vms',
    ...
    icon: Camera,
    items: [
      { path: '/cameras', label: 'Camera Grid', icon: Camera },
    ],
  },
  {
    id: 'analytics',
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/settings/workers', label: 'Edge Workers', icon: Server },
      { path: '/settings/operators', label: 'Operator Access', icon: Shield },
    ],
  },
];
      ...
      <div style={{
        ...
        >
          <div style={{
            ...
            <LogOut size={isCollapsed ? 14 : 16} strokeWidth={1.5} />
          </div>
          {!isCollapsed && (
            <span style={{ fontSize: '13px', fontWeight: 500 }}>
              Logout
