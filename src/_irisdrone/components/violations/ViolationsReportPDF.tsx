...
import { type TrafficViolation } from '@irisdrone/lib/api';
        ...
        <Document>
            <Page size="A4" style={styles.page} orientation="landscape">
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.subtitle}>Belagavi District Traffic Police - ITMS</Text>
                ...
                <View style={styles.footer}>
                    ...
                    <Text>Karnataka State Police, Belagavi District</Text>
                </View>
            </Page>
        </Document>
    );
