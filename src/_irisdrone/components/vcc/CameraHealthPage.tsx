...
import { Activity, Wifi, WifiOff, Clock, Plus, X, TrendingUp, Trash2, FileSpreadsheet } from 'lucide-react';
import { HealthReportModal } from '@irisdrone/components/vcc/HealthReportModal';
import {
    Chart as ChartJS,
    CategoryScale,
    LinearScale,
...
export function CameraHealthPage() {
    ...
    const [statusFilter] = useState<'all' | 'online' | 'offline'>('all');
